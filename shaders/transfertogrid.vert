...
uniform float u_zOffset; // Offset for the z layer we're splatting into.
varying float v_zIndex; // z layer we're splatting into.

void main () {
    gl_PointSize = 5.0; // TODO: Compute this more accurately.
